/* miniz_export.h - static build export header */
/* This file is generated manually for static builds (no shared library). */
...
/* For static linking, override all visibility macros */
#undef MINIZ_EXPORT
#define MINIZ_EXPORT
#undef MINIZ_NO_EXPORT
#define MINIZ_NO_EXPORT
